...
def main():
    # Only LGG
    ## Y - Mask Annotation
    load_dataset('C:/Users/nada/Documents/BRATS2017/Brats17TrainingData/', '**/*_seg.nii.gz', label=True, resize=(155,img_size,img_size))
    ## X - Features
    load_dataset('C:/Users/nada/Documents/BRATS2017/Brats17TrainingData/', '**/*_flair.nii.gz',label=False, resize=(155,img_size,img_size))
