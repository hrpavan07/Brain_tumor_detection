...
train_X = np.load('C:/Users/nada/Documents/x_{}.npy'.format(img_size))
train_Y = np.load('C:/Users/nada/Documents/y_{}.npy'.format(img_size))
print("Dataset loaded.")

model = unet_model()

print("Loading the model...")
model.load_weights('dice_weights_120_0.h5')
...
print("pred......")
for n in range(6):
    i = int(r.random() * pred.shape[1])
    x = train_X[i+total_examples, 1, :, :]
    y = train_Y[i+total_examples, 1, :, :]
    y_predicted = pred[i, 1, :, :]
